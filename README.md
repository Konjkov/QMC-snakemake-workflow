...
Download CASINO workflow from [repository](https://github.com/Konjkov/CASINO-workflow)
...
[config_00001.yaml](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/config_00001.yaml) for He-Li,
[config_0001.yaml](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/config_0001.yaml) for Be-N,
[config_003.yaml](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/config_0003.yaml) for O-Si,
[config_001.yaml](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/config_001.yaml) for P-Ar.

The [VMC optimization plan](https://github.com/Konjkov/CASINO-workflow/tree/master/opt_plan/emin.tmpl) was used in the first step performs
...
[graphs](https://github.com/Konjkov/CASINO-workflow/blob/master/ORCA/HF/def2-QZVP/vmc_opt.ipynb), in all cases, it would be enough only 4-5 steps.

Other useful graphs summarizing the results of this calculations are given.

* [__H__ (<sup>2</sup>S<sub>1/2</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/H)
...
* [__He__ (<sup>1</sup>S<sub>0</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/He)
...
* [__Li__ (<sup>2</sup>S<sub>1/2</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/Li)
...
* [__Be__ (<sup>1</sup>S<sub>0</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/Be)
...
* [__B__ (<sup>2</sup>P<sub>1/2</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/B)
    ...
    points out that next important configuration is 1s<sup>2</sup>2s<sup>1</sup>2p<sup>1</sup>3d<sup>1</sup>.

* [__C__ (<sup>3</sup>P<sub>0</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/C)

    The Hartree–Fock (HF) "trial" WFN for C also should be improved by adding 1s<sup>2</sup>2p<sup>4</sup> configuration, but this again does not give us an exact nodal surface.

* [__N__ (<sup>4</sup>S<sub>3/2</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/N)

    Only single determinant approximation was used.

* [__O__ (<sup>3</sup>P<sub>2</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/O)

    Only single determinant approximation was used.

* [__F__ (<sup>2</sup>P<sub>3/2</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/F)

    Only single determinant approximation was used.

* [__Ne__ (<sup>1</sup>S<sub>0</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/Ne)

    Only single determinant approximation was used.

* [__Na__ (<sup>1</sup>S<sub>0</sub>)](https://github.com/Konjkov/CASINO-workflow/tree/master/ORCA/HF/def2-QZVP/Na)
